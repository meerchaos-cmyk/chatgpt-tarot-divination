  ...
  return (
    ...
    >
      ...
      <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
        <div className="absolute top-0 left-1/4 w-[50vw] h-[50vw] max-w-[600px] max-h-[600px] bg-primary/5 rounded-full blur-[100px] animate-pulse" />
        <div className="absolute bottom-0 right-1/4 w-[40vw] h-[40vw] max-w-[500px] max-h-[500px] bg-secondary/10 rounded-full blur-[80px] animate-pulse delay-1000" />
      </div>
      ...
      <div className="w-full px-4 md:px-8 py-4 md:py-6">
        <div className="flex flex-col min-h-[calc(100vh-3rem)] md:px-12 lg:px-24">
          <motion.header
            ...
            className="glass rounded-2xl p-4 mb-8 sticky top-4 z-40 border border-white/10"
          >
