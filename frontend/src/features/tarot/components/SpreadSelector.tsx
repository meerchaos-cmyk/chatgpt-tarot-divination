          ...
          return (
            <button
              ...
              className={`
                ...
                ${isSelected
                  ? 'border-amber-500 bg-amber-900/10 shadow-[0_0_20px_rgba(245,158,11,0.2)] scale-[1.02]'
            ...
            >
              ...
              <div className="w-full flex justify-between items-start mb-4 relative z-10">
                <div>
                  ...
                  <span className="text-sm text-purple-300/50 uppercase tracking-wider font-light">{spread.name}</span>
                </div>
              ...
              <p className="text-base text-purple-200/70 mb-6 font-light leading-relaxed relative z-10">{spread.description}</p>
